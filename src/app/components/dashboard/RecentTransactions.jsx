...
import { Search, ChevronDown, Filter, Wallet } from "lucide-react";
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="py-2 w-72 bg-white border border-gray-200 rounded-xl text-sm text-gr focus:outline-none focus:ring-2 focus:ring-brand-500"
                        />
                    </div>
                    ...
                    <tbody>
                        {transactions.map((tx) => (
                            <tr key={tx.id} className="border-b last:border-0 hover:bg-gray-50">
                                <td className="p-3 font-bold text-gray-800">{tx.activity}</td>
                                <td className="p-3 font-bold text-gray-800">{tx.id}</td>
                                <td className="p-3 font-bold text-gray-800">{tx.date}</td>
