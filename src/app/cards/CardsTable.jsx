...
import { Search, Wallet, MoreHorizontal, SquareIcon, PlusCircle } from "lucide-react";
    ...
    return (
        <div>
            <div className="flex items-center justify-end">
                <button onClick={openModal} className="flex gap-2 items-center space-x-2 border border-gray-200 bg-gray-100 rounded-xl px-3 py-3 text-md font-bold text-gray-800 hover:bg-gray-50 transition-colors">
                ...
                <table className="min-w-full text-sm text-left">
                    <thead className="text-gray-500 bg-gray-50">
                        <tr className="border-b border-gray-200">
                            <th className="p-3 w-12"><SquareIcon size={20} /></th>
