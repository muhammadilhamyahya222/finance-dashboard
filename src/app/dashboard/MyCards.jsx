        ...
        <div className="bg-white p-6 rounded-2xl h-full flex flex-col">
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="relative">
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="flex items-center space-x-2 text-gray-600 bg-gray-100 px-3 py-1 rounded-lg hover:bg-gray-200 transition-colors">
